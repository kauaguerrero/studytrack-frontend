    ...
    <Card className="border-0 shadow-sm ring-1 ring-slate-200 dark:ring-slate-800 bg-white dark:bg-slate-900">
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-lg font-bold flex items-center gap-2 text-slate-900 dark:text-slate-50">
              <BarChart3 className="w-5 h-5 text-indigo-600 dark:text-indigo-400" /> Ritmo de Estudos
            </CardTitle>
            <CardDescription className="text-slate-500 dark:text-slate-400">Volume de questões nos últimos 30 dias</CardDescription>
          </div>
