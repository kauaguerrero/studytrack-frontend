                    ...
                    <main className="flex-1 max-w-3xl mx-auto w-full p-4 md:p-8 pb-32">
                        <div className="bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-slate-200">
                            ...
                            <div className="flex flex-wrap gap-2 mb-6">
                                <span className="bg-blue-50 text-blue-700 text-xs font-bold px-3 py-1 rounded-full">{questions[currentIdx].subject}</span>
                                {questions[currentIdx].topic && <span className="bg-purple-50 text-purple-700 text-xs font-bold px-3 py-1 rounded-full">{questions[currentIdx].topic}</span>}
                            </div>
                            ...
                            <div className="text-lg md:text-xl text-slate-900 font-medium mb-8 leading-relaxed">{questions[currentIdx].statement}</div>
