  ...
  return (
    ...
    >
      <motion.div
        ...
        className="group relative rounded-2xl p-5 border border-white/10 h-full transition-colors duration-300"
      >
        <div
...
export function FeaturesSection() {
  return (
    <section id="funcionalidades" className="py-20 sm:py-28 bg-[#0F172A] relative overflow-hidden">
      <div
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map(({ icon: Icon, title, description }, i) => (
            <TiltCard key={i} delay={i * 0.06}>
              <motion.div
                className="w-9 h-9 rounded-xl bg-blue-500/15 border border-blue-400/20 flex items-center justify-center mb-4 group-hover:bg-blue-500/25 transition-colors"
