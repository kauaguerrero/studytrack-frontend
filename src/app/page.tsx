...
// --- CSS CUSTOMIZADO (Para animações que o Tailwind padrão não cobre nativamente sem config) ---
const customStyles = `
  @keyframes float {
...
export default function Home() {
  ...
  // Simulação do Chat Automático (Storytelling Visual)
  useEffect(() => {
    const timers = [
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden selection:bg-blue-200 selection:text-blue-900">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="flex items-center gap-2 font-extrabold text-2xl tracking-tight text-slate-900 cursor-pointer">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white border-t border-slate-100 shadow-xl flex flex-col p-4 gap-4 animate-fade-in-up">
            <a href="#planos" className="text-slate-700 font-medium p-2">Planos</a>
      ...
      <main className="relative z-10">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
              ...
              <div className="flex-1 text-center lg:text-left animate-fade-in-up">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-blue-700 text-xs font-bold mb-8 uppercase tracking-wide hover:bg-blue-100 transition-colors cursor-pointer">
                  ...
                  CORREÇÃO DE REDAÇÕES DISPONÍVEL
                </div>
                ...
                <p className="text-lg md:text-xl text-slate-600 mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0">
                  O StudyTrack substitui cursinhos caros por uma IA que vive no seu WhatsApp. Cronogramas que se adaptam à sua preguiça e correções que ensinam mais que seu professor.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <a href="#demo" className="px-8 py-4 rounded-2xl bg-white border border-slate-200 text-slate-700 font-semibold text-lg hover:bg-slate-50 hover:border-slate-300 transition-all flex items-center justify-center gap-2">
                    <TrendingUp className="w-5 h-5" />
                    Ver Resultados
                  </a>
                </div>

                <div className="mt-10 flex items-center justify-center lg:justify-start gap-4 text-sm text-slate-500 border-t border-slate-200 pt-6">
                </div>
              </div>

              {/* Lado Direito: SIMULAÇÃO INTERATIVA */}
                ...
                <div className="relative mx-auto border-slate-900 bg-slate-900 border-[12px] rounded-[2.5rem] h-[620px] w-[320px] shadow-2xl overflow-hidden">
                  ...
                  <div className="w-full h-full bg-[#E4E2DC] relative flex flex-col font-sans">
                    ...
                    <div className="bg-[#F0F2F5] px-2 py-2 flex items-center gap-2">
                      ...
                      <div className="flex-1 bg-white rounded-full h-9 px-4 flex items-center text-slate-400 text-sm">
                        Vou começar agora!
                      </div>
        ...
        <section id="recursos" className="py-24 bg-slate-50 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-slate-600">O StudyTrack não é apenas um chatbot. É um sistema completo de engenharia pedagógica rodando no seu bolso. Nossa plataforma fornece todas as ferramentas necessárias para garantir a aprovação no curso dos seus sonhos.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="group bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl hover:border-blue-100 hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-3">Redação Nota 1000</h3>
                  <p className="text-slate-600 mb-4">Apenas envie seu texto e nós fazemos o resto. O StudyTrack corrige, ensina e avalia as 5 competências em segundos.</p>
                  <a href="#" className="text-blue-600 font-bold flex items-center gap-1 text-sm group-hover:gap-2 transition-all">Ver exemplo <ArrowRight className="w-4 h-4"/></a>
                </div>
              </div>
              ...
              <div className="group bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl hover:border-purple-100 hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-600 mb-4">Ficou doente? Saiu para uma festa? O sistema recalcula automaticamente sua rota de estudos. Sem culpa, apenas ajuste.</p>
                  <a href="#" className="text-purple-600 font-bold flex items-center gap-1 text-sm group-hover:gap-2 transition-all">Ver exemplo <ArrowRight className="w-4 h-4"/></a>
                </div>
              </div>
              ...
              <div className="group bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl hover:border-orange-100 hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-600 mb-4">Não é sobre pontos inúteis. Mantenha sua sequência (streak) e ganhe benefícios, descontos e aprendizado.</p>
                  <a href="#" className="text-orange-500 font-bold flex items-center gap-1 text-sm group-hover:gap-2 transition-all">Ver exemplo <ArrowRight className="w-4 h-4"/></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-16">
              ...
              <div className="inline-flex bg-slate-800 p-1 rounded-full border border-slate-700">
                <button className="px-6 py-2 rounded-full bg-blue-600 text-sm font-bold shadow-lg transition-all hover:scale-105">Mensal</button>
                <button className="px-6 py-2 rounded-full text-slate-400 text-sm font-medium hover:text-white transition-colors">Anual (2 meses grátis)</button>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-end">
              ...
              <div className="bg-slate-800/40 backdrop-blur-md border border-slate-700 p-8 rounded-3xl relative group hover:border-slate-500 transition-all">
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-slate-700 text-slate-300 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide">
                  Degustação
                </div>
                ...
                <a href="/auth/register?plan=trial" className="block w-full py-3 rounded-xl border border-slate-600 hover:bg-slate-700 text-center font-semibold transition-all">
                  Testar Agora
                </a>
                
                <div className="mt-8 space-y-3 text-sm text-slate-300">
                  <p className="flex gap-2 text-slate-400"><CheckCircle className="w-4 h-4"/> Acesso ao Chat IA</p>
                  <p className="flex gap-2 text-slate-400"><CheckCircle className="w-4 h-4"/> 1 Correção de Redação</p>
                  <p className="flex gap-2 text-slate-500 line-through"><ShieldCheck className="w-4 h-4"/> Histórico ilimitado</p>
                </div>
              </div>
              ...
              <div className="bg-slate-800/60 backdrop-blur-md border border-slate-600 p-8 rounded-3xl relative hover:bg-slate-800 transition-all">
                ...
                <a href="/auth/register?plan=basic" className="block w-full py-3 rounded-xl bg-slate-700 text-white hover:bg-slate-600 text-center font-semibold transition-all border border-slate-600">
                  Assinar Básico
                </a>
                
                <div className="mt-8 space-y-3 text-sm text-slate-300">
                  <p className="flex gap-2"><CheckCircle className="w-4 h-4 text-blue-400"/> Cronograma Standard</p>
                  <p className="flex gap-2"><CheckCircle className="w-4 h-4 text-blue-400"/> <strong>2 Redações</strong>/mês</p>
                  <p className="flex gap-2"><CheckCircle className="w-4 h-4 text-blue-400"/> Chat IA (Limitado)</p>
                  <p className="flex gap-2 text-slate-500 line-through"><Zap className="w-4 h-4"/> Modo Intensivo</p>
                </div>
              </div>

              {/* PLANO PRO (R$ 29,90 - ANCORAGEM PRINCIPAL) */}
              <div className="bg-gradient-to-b from-blue-600 to-blue-900 p-8 rounded-3xl shadow-2xl shadow-blue-900/50 transform md:scale-110 border border-blue-400 relative animate-pulse-glow z-10">
                ...
                <a href="/auth/register?plan=pro" className="block w-full py-4 rounded-xl bg-white text-blue-700 text-center font-bold hover:bg-blue-50 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                  Quero Ser Aprovado
                </a>
                
                <div className="mt-8 space-y-4 text-sm text-white font-medium">
                  <p className="flex gap-3 items-center"><div className="p-1 bg-blue-500 rounded-full shrink-0"><CheckCircle className="w-3 h-3"/></div> <strong>Redações Ilimitadas</strong></p>
                  ...
                  <p className="flex gap-3 items-center"><div className="p-1 bg-blue-500 rounded-full shrink-0"><TrendingUp className="w-3 h-3"/></div> Dashboard de Performance</p>
                </div>
              </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-4">
              {[
                "A IA corrige redação modelo ENEM?",
                "Funciona se eu não tiver computador?",
                "Posso cancelar se não gostar?",
                "O cronograma serve para Medicina?"
              ].map((q, i) => (
                <div key={i} className="border border-slate-200 rounded-2xl p-6 hover:border-blue-200 cursor-pointer group transition-all bg-slate-50 hover:bg-white">
                  <div className="flex justify-between items-center">
                    <h3 className="font-bold text-slate-700 group-hover:text-blue-600">{q}</h3>
                    <ChevronDown className="w-5 h-5 text-slate-400 group-hover:text-blue-600 transition-transform group-hover:rotate-180" />
                  </div>
                </div>
              ))}
            </div>
        ...
        <footer className="bg-slate-50 pt-20 pb-10 border-t border-slate-200">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-slate-500 mb-8">Feito com 💙 e muita cafeína por estudantes para estudantes.</p>
            ...
            <p className="text-slate-400 text-sm">© 2024 StudyTrack Education. Todos os direitos reservados.</p>
          </div>
        </footer>
