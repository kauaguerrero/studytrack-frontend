          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {handoff.map((item) => {
                ...
                return (
                  <tr key={item.session_phone} className="border-b border-slate-50 dark:border-zinc-800/60 last:border-0">
                    ...
                    <td className="px-4 py-3 text-slate-500 dark:text-zinc-400">{timeSince(item.handoff_at)}</td>
                    <td className="px-4 py-3">
