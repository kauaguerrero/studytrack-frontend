...
const FLOAT_CARDS = [
  { text: "+23% desempenho médio",    dur: 3, delay: 0,   pos: "absolute -left-24 top-8 z-20"     },
  { text: "98% simulados corrigidos",  dur: 4, delay: 1.3, pos: "absolute -right-24 top-32 z-20"   },
  { text: "Decisão baseada em dados",  dur: 5, delay: 2.6, pos: "absolute bottom-14 left-1/3 z-20" },
];

// ─── HeroBg (light gradient) ─────────────────────────────────────────────────
  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden>
      <div
        ...
        style={{ background: "linear-gradient(180deg, #FFFFFF 0%, #F0F4FF 45%, #FFFFFF 100%)" }}
      />
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse at 50% 45%, rgba(6,182,212,0.12) 0%, rgba(99,102,241,0.08) 55%, transparent 78%)" }}
        aria-hidden
      />

      {/* Floating mini cards — outer: parallax, inner: float */}
      {FLOAT_CARDS.map(({ text, dur, delay, pos }) => (
        <motion.div key={text} className={`${pos} pointer-events-none`} style={{ x: floatX, y: floatY }}>
          <motion.div
            className="rounded-xl px-3 py-2 text-[11px] font-semibold text-[#1A1A2E] border border-[#E2E8F0] flex items-center gap-1.5 whitespace-nowrap"
            style={{
              background: "#FFFFFF",
      ...
      >
        ...
        <div
          ...
          style={{ width: "80%", height: 24, background: "rgba(99,102,241,0.20)", filter: "blur(20px)", borderRadius: "50%" }}
          aria-hidden
        />
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 sm:pt-24 pb-16 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-5 sm:gap-6">
            ...
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#1A1A2E] leading-[1.08] tracking-tight"
            >
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="text-base sm:text-lg text-[#4A5568] leading-relaxed max-w-xl"
            >
            ...
            >
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <a
                  href="#parceiros"
                  className="inline-flex items-center justify-center gap-2 px-6 sm:px-7 py-3.5 rounded-xl text-[#4A5568] font-semibold text-base border border-[#E2E8F0] hover:border-[#6366F1] hover:text-[#6366F1] transition-all duration-200"
                >
              ...
              <div className="flex items-center gap-2 text-sm text-[#6B7280]">
                <a
                  href="/auth/login"
                  className="inline-flex items-center gap-1.5 hover:text-[#6366F1] transition-colors"
                >
                  <User className="w-3.5 h-3.5" /> Sou aluno
                </a>
                <span>·</span>
                <a
                  href="/auth/login"
                  className="inline-flex items-center gap-1.5 hover:text-[#6366F1] transition-colors"
                >
                  <Building2 className="w-3.5 h-3.5" /> Sou parceiro
                </a>
              </div>
            </motion.div>
            ...
            >
              <div className="flex flex-col">
                <span className="text-xl sm:text-2xl font-extrabold text-[#1A1A2E] tabular-nums">
                  <AnimatedCounter to={5000} suffix="+" />
                </span>
                <span className="text-xs text-[#9CA3AF]">questões catalogadas</span>
              </div>
              <div className="w-px h-7 bg-[#E2E8F0] hidden sm:block" />
              <div className="flex flex-col">
                <span className="text-xl sm:text-2xl font-extrabold text-[#1A1A2E]">100%</span>
                <span className="text-xs text-[#9CA3AF]">white-label</span>
              </div>
              <div className="w-px h-7 bg-[#E2E8F0] hidden sm:block" />
              <div className="flex flex-col">
                <span className="text-xl sm:text-2xl font-extrabold text-[#1A1A2E]">Real-time</span>
                <span className="text-xs text-[#9CA3AF]">dados de desempenho</span>
              </div>
            </motion.div>
      ...
      <motion.div
        ...
        aria-hidden
      >
        <div className="w-5 h-8 rounded-full border border-[#1A1A2E]/20 flex items-start justify-center pt-1.5">
          <div className="w-1 h-2 rounded-full bg-[#1A1A2E]/25" />
        </div>
      </motion.div>
    </section>
  );
