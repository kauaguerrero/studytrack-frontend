  ...
  const handleValidation = async () => {
    ...
    try {
        ...
        if (mode === 'code') {
            ...
            router.refresh();
            router.push('/portal/secretariat');
            ...
            router.push('/portal/onboarding/secretariat/pending');
        }
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-slate-900">
      <div className="max-w-md w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="mb-8 text-center">
            ...
            <p className="text-slate-500 mt-2">Para acessar o painel da secretaria, precisamos validar seu vínculo com uma instituição parceira.</p>
        </div>
        ...
        <div className="mt-4 text-center">
            <p className="text-[10px] text-slate-300">Dev Hint: Use o código <strong>SEC-2025</strong> para testar.</p>
        </div>
